...
ICONS = {
    ...
    # hand-drawn whale mark (DeepSeek has no simple-icons glyph)
    "deepseek": "M2 12c1.5-4.4 5.3-7.5 10.1-7.5 3.5 0 6.7 1.6 8.6 4.2 1.2-.1 2.2.2 3 .8-1.1.1-2 .5-2.7 1.2 1 .9 1.8 2.1 2 3.5-1.1-.9-2.5-1.3-3.9-1.1-.7 4-4.2 6.9-8.4 6.9C6 20 2.4 16.8 2 12Zm4.5-.5a1.2 1.2 0 1 0 0 2.4 1.2 1.2 0 0 0 0-2.4Z",
}

# Provider rows, top to bottom. `new` is reserved for models that are still
